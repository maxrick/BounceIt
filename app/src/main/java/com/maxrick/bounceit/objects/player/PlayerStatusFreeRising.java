...
import com.maxrick.bounceit.events.DrawFingerSwipeLeftEvent;
import com.maxrick.bounceit.events.DrawFingerSwipeRightEvent;
import com.maxrick.bounceit.game.GamePanel;
import com.maxrick.bounceit.events.ResetPowerDisplayEvent;
...
public class PlayerStatusFreeRising extends PlayerStatus {
    ...
    public Height calculatePos(PlayerPower playerPower, int maxHeight, XPosition xPosition, Player player, Trampolin trampolin) throws PlayerDiedException {
        ...
        testDieSet=false;
        xPosition.move();
        Height curHeight = new Height((int) (-0.5 * gravitaion * Math.pow((elapsedSeconds - Math.sqrt(2 * maxHeight / gravitaion)), 2) + maxHeight));
